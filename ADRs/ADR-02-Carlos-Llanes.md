...
## Decisión de Infraestructura y Despliegue

Alojamiento en Amazon Web Services (AWS) utilizando una instancia EC2 y Amazon RDS para SQL Server.

### ¿Por qué?

Para el entorno de producción académico, se optó por utilizar la capa gratuita (Free Tier) de AWS. La API de DojoFlow (.NET 10) se alojará en una instancia Amazon EC2, mientras que la base de datos será gestionada por Amazon RDS utilizando el motor SQL Server Express. Esta combinación garantiza una integración nativa con Entity Framework Core y proporciona una arquitectura de red privada profesional, manteniendo el costo de infraestructura en $0.00 durante el desarrollo del proyecto.
